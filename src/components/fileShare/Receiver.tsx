        ...
        peerConnection.current.onconnectionstatechange = () => {
            if (
                ...
                showSwal(
                    ...
                    "File transfer has cancelled because the sender disconnected",
                    "info",
                );
                ...
                if (typeof event.data === "string") {
                    ...
                    if (msg.type === "cancel") {
                        ...
                        showSwal(
                            ...
                            "File has been cancelled by sender",
                            "info",
                        );
                        return;
                    }
                    ...
                    const percent =
                        (currentFileSize.current / metaRef.current.size) * 100;
